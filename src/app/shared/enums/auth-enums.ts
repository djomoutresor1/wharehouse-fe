export enum Auth {
  ...
  WAREHOUSE_DELETE_USER = '/delete/user',
  WAREHOUSE_UPDATE_USER = '/update/user',
  WAREHOUSE_DELETE_ORGANIZATION = '/delete/organization',
  WAREHOUSE_UPDATE_ORGANIZATION = '/update/organization',
  WAREHOUSE_UPDATE_EMAIL_PEC_USER = '/update/email-pec',
  WAREHOUSE_REGISTER_USER_STEP_THREE = '/register/step-three',
  WAREHOUSE_ACTIVATE_DESATTIVATE_USER = '/activation',
  WAREHOUSE_CHANGE_STATUS_USER = '/change/status',
  WAREHOUSE_REFRESH_TOKEN = '/refreshtoken',
  WAREHOUSE_VERIFY_TOKEN = '/verifytoken',
  WAREHOUSE_FIND_USER = '/find/user',
  WAREHOUSE_FIND_ORGANIZATION = '/find/organization',
